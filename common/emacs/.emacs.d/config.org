...
** disable backups/auto-save files/lock files
#+BEGIN_SRC emacs-lisp
...
** highlight lines (window mode only)
#+BEGIN_SRC emacs-lisp
...
** symbols (switch text to symbols)
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
** calc org-mode table column selection (my-org-column)  [C-x s]
...
** case insentive folder search  [C-o]
#+BEGIN_SRC emacs-lisp
...
** setting the default terminal to ansi-term
#+BEGIN_SRC emacs-lisp
...
#+RESULTS:
| r | relatorio tcc | entry | (file+headline ~/Desk/TCC_rdo/textos_tcc/relat_tcc.org March) | * %<%d/%m/%Y> |
...
*** text highlight (org-emphasis-alist)
  #+begin_src emacs-lisp
...
*** org-priorities (increase/decrease)
#+begin_src emacs-lisp
...
** list update candidates (list-packages)
 #+BEGIN_SRC emacs-lisp
...
** 80 rule column delimiter _(DISABLED)_
#+begin_src emacs-lisp
  ;; (require 'whitespace)
...
** launch terminal (ansi-term)  _[DISABLED]_
#+BEGIN_SRC emacs-lisp
...
** evaluate & replace last expression (sexp)
#+BEGIN_SRC emacs-lisp
...
** fuzzy finder (fzf)
!! trocar por ripgrep? n consigui fazer
a buscar em pastas especificas ainda
  #+BEGIN_SRC emacs-lisp
...
[[https://github.com/magnars/multiple-cursors.el][Git link]]
** project (A TESTAR?)
#+BEGIN_SRC emacs-lisp
...
[[https://github.com/bbatsov/projectile][Git Link]]

** Emacs Dashboard
!Não colocar items que vc não tenha funcionando
ex: projectile (se não usar não coloque!)
...
[[https://github.com/emacs-dashboard/emacs-dashboard][Git Link]]
...
[[https://github.com/emacscollective/auto-compile][Git Link]]
...
[[https://github.com/abo-abo/avy][Git Link]]

** sudo edit (uses TRAMP)
   #+begin_src emacs-lisp
...
[[https://github.com/myrjola/diminish.el][Git Link]]
...
[[https://github.com/gonewest818/dimmer.el][Git Link]]
...
[[https://github.com/TheBB/spaceline][Git link]]
...
[[https://github.com/seagle0128/doom-modeline][Git link]]
...
(setq org-file-apps
  '((auto-mode . emacs)
    ...
    (directory . emacs)))
#+END_SRC
[[https://github.com/politza/pdf-toolshttps://github.com/vedang/pdf-tools][Git link]]
...
[[https://github.com/benma/visual-regexp.el/][Git Link]]
...
[[http://pragmaticemacs.com/emacs/regions-marks-and-visual-mark/][PRAGMATIC EMACS]]
...
*** useful cfg's
 ...
 #+RESULTS:
 | #[nil ((ibuffer-switch-to-saved-filter-groups Default)) nil] | pdf-occur-ibuffer-minor-mode |
...
[[https://github.com/domtronn/all-the-icons.el][Git Link]]
...
[[https://github.com/wyuenho/all-the-icons-dired][Git Link]]
...
[[https://github.com/mattiasb/dired-hide-dotfiles][Link]]
...
[[http://pragmaticemacs.com/emacs/copy-and-paste-files-with-dired-ranger/][PRAGMATIC EMACS]]
...
[[https://gitlab.com/xuhdev/dired-quick-sort][Git Link]]
...
[[https://github.com/stathissideris/ditaa][Git link]]

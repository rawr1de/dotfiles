...
#           setfont sun12x22
           ...
           echo
           echo "# installing base and essentials"
           echo
           sleep 3
           pacstrap /mnt base base-devel linux-zen linux-zen-docs linux-zen-headers linux-firmware intel-ucode haveged wget git neovim netctl networkmanager network-manager-applet dhcpcd wireless_tools dialog wpa_supplicant mtools dosfstolls cups os-prober efibootmgr grub man-db man-pages texinfo

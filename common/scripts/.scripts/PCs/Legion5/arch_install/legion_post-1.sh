...
echo "##                                          ##"
echo "##  (4) Set timezone manually               ##"
echo "##      ln -sf                              ##" 
echo "## /usr/share/zoneinfo/XX/X /etc/localtime  ##"
echo "##                                          ##"
echo "##  (5) Set locale manually (uncomment)     ##"
echo "##      en_US.UTF-8  in  /etc/locale.gen    ##"
echo "##      # locale-gen                        ##"
echo "##                                          ##"
echo "##                                          ##"
echo "##                                          ##"
...
# (2) manuseia o argumento passado [s/n]
  case $ANS in
   [sS]* ) # echo
           ...
           echo
           echo "# setting system language to: English (US) - UTF 8"
           sleep 2
           echo "LANG=en_US.UTF-8" > /etc/locale.conf
           
           ## create hostname config file
           echo
           echo "# setting hostname as: 'legion'"
           sleep 2
           ...
           echo -e "127.0.1.1	legion.localdomain	legion" >> /etc/hosts
           ...
           echo "#########################################################################################"
           echo "##                                                                                     ##"
           echo "##  (1) Change root password to: root001                                               ##"
           echo "##                                                                                     ##"
           echo "##  (2) Install & configure grub:                                                      ##"
           echo "##      # grub-install --target=x86_64-efi --efi-directory=/boot --bootloader-id=GRUB  ##"
           echo "##                                                                                     ##"
           echo "##      Windows/Linux systems must be recognised, if not check mounts/fstab            ##"
           echo "##      also check linux boot files (vmlinuz, initram..) and                           ##"
           echo "##      update system with:  # pacman -Syu                                             ##"
           echo "##                                                                                     ##"
           echo "##      if it still fails, re-install kernel with:  # pacman -S linux-zen              ##"
           echo "##      it creates the boot/mkinitcpio files                                           ##"
           echo "##                                                                                     ##"
           echo "##      then run:  # mkinitcpio -p kernel_name  (e.g. linux-zen)                       ##"
           echo "##                   (files reside in  /etc/mkinitcpio.d/)                             ##"
           echo "##                                                                                     ##"
           echo "##      then update the system with:  # grub-mkconfig -o /boot/grub/grub.cfg           ##"
           echo "##                                                                                     ##"
           echo "##  (3) Run script legion-post-2.sh                                                    ##"
           echo "##      after login into new system to                                                 ##"
           echo "##      install last packages/configs                                                  ##"
           echo "##                                                                                     ##"
           echo "#########################################################################################"
           echo
           echo
